...
class TrailClose extends StatefulWidget {
  _TrailCloseState createState() => new _TrailCloseState();
}

class _TrailCloseState extends State<TrailClose>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              23, 0, 'assets/images/ori_opentra/2原角度——开尾门_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
