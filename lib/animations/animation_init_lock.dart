...
class InitLock extends StatefulWidget {
  _InitLockState createState() => new _InitLockState();
}

class _InitLockState extends State<InitLock>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              46, 46, 'assets/images/unlock_lock/解锁——上锁 原角度_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
