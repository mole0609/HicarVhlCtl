...
class windowClose extends StatefulWidget {
  _windowCloseState createState() => new _windowCloseState();
}

class _windowCloseState extends State<windowClose>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              23, 0, 'assets/images/ori_openwin/1原角度——开窗_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
