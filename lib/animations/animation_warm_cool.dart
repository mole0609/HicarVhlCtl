...
class WarmToCool extends StatefulWidget {
  _WarmToCoolState createState() => new _WarmToCoolState();
}

class _WarmToCoolState extends State<WarmToCool>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              0, 32, 'assets/images/warm_cool/11温暖 ——- 清凉_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
