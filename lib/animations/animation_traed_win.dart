...
class TraedAndWin extends StatefulWidget {
  _TraedAndWinState createState() => new _TraedAndWinState();
}

class _TraedAndWinState extends State<TraedAndWin>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              0, 12, 'assets/images/traed_and_win/4开尾门——开窗和开尾门_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
