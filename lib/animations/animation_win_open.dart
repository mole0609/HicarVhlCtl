...
class WindowOpen extends StatefulWidget {
  _WindowOpenState createState() => new _WindowOpenState();
}

class _WindowOpenState extends State<WindowOpen>
      ...
      child: new Container(
        child: new ImagesAnimation(
          ...
          entry: ImagesAnimationEntry(
              0, 23, 'assets/images/ori_openwin/1原角度——开窗_000%s.jpg'),
          h: 230,
          w: 328,
        ),
      ),
